...
import {
  ...
  useMultiStyleConfig,
  warn
} from "./chunk-U23NNHNZ.js";
import "./chunk-6UHNYVXZ.js";
import {
  require_react
...
function useAccordionItem(props) {
  const { isDisabled, isFocusable, id: id3, ...htmlProps } = props;
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    return (0, import_jsx_runtime3.jsx)(AccordionItemProvider, { value: ctx, children: (0, import_jsx_runtime3.jsx)(
      chakra.div,
      {
        ref,
        ...htmlProps,
...
var variants = {
  exit: ({
    ...
    return {
      ...
      transition: (_a = transition == null ? void 0 : transition.exit) != null ? _a : withDelay.exit(defaultTransitions.exit, delay2)
    };
  },
  enter: ({
    animateOpacity,
    ...
    return {
      ...
      transition: (_a = transition == null ? void 0 : transition.enter) != null ? _a : withDelay.enter(defaultTransitions.enter, delay2)
    };
  }
};
var Collapse = (0, import_react52.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
    ...
    return (0, import_jsx_runtime4.jsx)(AnimatePresence, { initial: false, custom, children: show && (0, import_jsx_runtime4.jsx)(
      motion.div,
      {
        ref,
        ...rest,
...
var variants2 = {
  enter: ({ transition, transitionEnd, delay: delay2 } = {}) => {
    ...
    return {
      opacity: 1,
      transition: (_a = transition == null ? void 0 : transition.enter) != null ? _a : withDelay.enter(TRANSITION_DEFAULTS.enter, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.enter
    };
  },
  exit: ({ transition, transitionEnd, delay: delay2 } = {}) => {
    ...
    return {
      opacity: 0,
      transition: (_a = transition == null ? void 0 : transition.exit) != null ? _a : withDelay.exit(TRANSITION_DEFAULTS.exit, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    };
  }
};
...
var Fade = (0, import_react53.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
  ...
  return (0, import_jsx_runtime5.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime5.jsx)(
    motion.div,
    {
      ref,
...
var ScaleFade = (0, import_react54.forwardRef)(
  function ScaleFade2(props, ref) {
    ...
    return (0, import_jsx_runtime6.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime6.jsx)(
      motion.div,
      {
        ref,
...
var SlideFade = (0, import_react55.forwardRef)(
  function SlideFade2(props, ref) {
    ...
    return (0, import_jsx_runtime7.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime7.jsx)(
      motion.div,
      {
        ref,
        className: cx("chakra-offset-slide", className),
...
var variants5 = {
  exit: ({ direction, transition, transitionEnd, delay: delay2 }) => {
    ...
    return {
      ...exitStyles,
      transition: (_a = transition == null ? void 0 : transition.exit) != null ? _a : withDelay.exit(defaultTransition.exit, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.exit
    };
  },
  enter: ({ direction, transitionEnd, transition, delay: delay2 }) => {
    ...
    return {
      ...enterStyles,
      transition: (_a = transition == null ? void 0 : transition.enter) != null ? _a : withDelay.enter(defaultTransition.enter, delay2),
      transitionEnd: transitionEnd == null ? void 0 : transitionEnd.enter
    };
  }
};
var Slide = (0, import_react56.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style,
    unmountOnExit,
  ...
  return (0, import_jsx_runtime8.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime8.jsx)(
    motion.div,
    {
      ...rest,
      ref,
...
var AccordionPanel = forwardRef(
  function AccordionPanel2(props, ref) {
    ...
    const child = (0, import_jsx_runtime9.jsx)(chakra.div, { ...panelProps, __css: styles.panel, className: _className });
    if (!reduceMotion) {
      return (0, import_jsx_runtime9.jsx)(Collapse, { in: isOpen, ...motionProps, children: child });
    }
    return child;
  }
);
...
var Accordion = forwardRef(function Accordion2({ children, reduceMotion, ...props }, ref) {
  ...
  const ctx = (0, import_react57.useMemo)(
    () => ({ ...context, reduceMotion: !!reduceMotion }),
    [context, reduceMotion]
  );
  return (0, import_jsx_runtime10.jsx)(AccordionDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime10.jsx)(AccordionProvider, { value: ctx, children: (0, import_jsx_runtime10.jsx)(AccordionStylesProvider, { value: styles, children: (0, import_jsx_runtime10.jsx)(
    chakra.div,
    {
      ref,
      ...htmlProps,
...
//# sourceMappingURL=@chakra-ui_accordion.js.map
